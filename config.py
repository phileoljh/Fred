...
INDICATORS = [
    ...
    {"id": "PCE", "name": "個人消費支出 (PCE)", "freq": "Priority", "category": "榮景期指標 (Priority)", "units": "pc1", "format": "{value}% YoY", "points": 12},
    ...
    # 衰退期指標 (Recession)
    {"id": "PCE", "name": "個人消費支出 (PCE)", "freq": "Recession", "category": "衰退期指標 (Recession)", "units": "pc1", "format": "{value}% YoY", "points": 12},
    ...
    {"id": "PCEDG", "name": "耐久財消費支出 (PCE: Durable Goods)", "freq": "Recovery", "category": "復甦期指標 (Recovery)", "units": "pc1", "format": "{value}% YoY", "points": 12},
    {"id": "RSXFS", "name": "零售銷售 (Retail Sales)", "freq": "Recovery", "category": "復甦期指標 (Recovery)", "units": "pc1", "format": "{value}% YoY", "points": 12},
    {"id": "DGORDER", "name": "耐久財新訂單 (Durable Goods Orders)", "freq": "Recovery", "category": "復甦期指標 (Recovery)", "units": "pc1", "format": "{value}% YoY", "points": 12},
    ...
    {"id": "PCE", "name": "個人消費支出 (PCE)", "freq": "Monthly", "category": "Consumption & Sentiment", "units": "pc1", "format": "{value}% YoY", "points": 12},
    {"id": "PCEDG", "name": "耐久財消費支出 (PCE: Durable Goods)", "freq": "Monthly", "category": "Consumption & Sentiment", "units": "pc1", "format": "{value}% YoY", "points": 12},
    ...
    {"id": "DGORDER", "name": "耐久財新訂單 (Durable Goods Orders)", "freq": "Monthly", "category": "Production & Manufacturing", "units": "pc1", "format": "{value}% YoY", "points": 12},
    ...
    {"id": "GDP", "name": "國內生產毛額 (GDP)", "freq": "Quarterly", "category": "GDP Output", "units": "pc1", "format": "{value}% YoY", "points": 4},
